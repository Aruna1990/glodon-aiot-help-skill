---
name: glodon-ai-help
description: 广联达行业 AI 平台 (glodon-ai-platform) 使用问题解答。平台功能介绍依据语雀文档；@glodon-aiot 相关 npm 包需通过读取 npm 网站介绍文档回答。支持平台入门指导、API 调用帮助、故障排查、文档检索、自动学习。
---

# 广联达行业 AI 平台帮助技能

> **版本**: 1.4.1 | **平台文档**: 语雀 | **npm 包**: 读取 npm 网站 | **更新**: 2026-03-23
...
| **@glodon-aiot npm 包**（安装、配置、API、用法） | NPM 网站 | **必须读取** https://www.npmjs.com/package/包名 的介绍文档 |
...
| 前端 SDK（代码/配置/API 细节） | 访问并读取 NPM 包页 `https://www.npmjs.com/package/@glodon-aiot/chat-app-sdk` |
...
- **v1.4.1** (2026-03-23): 明确双源回答规则 ⭐
  ...
  - **@glodon-aiot npm 包** → 必须读取 NPM 网站 (https://www.npmjs.com/package/包名) 介绍文档回答
  - 新增「文档来源对照表」与「知识库来源（双源）」说明
